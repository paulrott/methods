...
class Circle:
  ...
  def __init__(self, radius=1):
    self.radius = radius
    self.circunference = 2 * self.pi * self.radius

  def get_area(self):
    return self.pi * (self.radius ** 2)

  # def get_circunfeference(self):
...
print(circle_1.circunference)
# print(circle_1.get_circunfeference())
# circle_2 = Circle(3)
# print(circle_2.get_area())
# print(circle_2.get_circunfeference())
# # circle_3 = Circle(5)
# circle_area = circle_3.get_area()
# print(circle_area)
# print(circle_3.get_circunfeference())